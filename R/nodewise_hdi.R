...
# (file R/helpers.nodewise.R; archived CRAN tarball hdi_0.1-10.tar.gz,
# sha256 15f37a620e2c51b158d50472e442b34391c7eef92acd9291e8d468e14ba49206).
# hdi is Copyright (C) Lukas Meier, Ruben Dezeure, Nicolai Meinshausen,
# Martin Maechler and Peter Buehlmann, licensed under the GPL; the nodewise
# code below was written by Ruben Dezeure. It is redistributed here under
